  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          RaisedButton(onPressed:(){},child:Row(children:[Icon(Icons.edit),Text('Edit Profile')]),color: Colors.green,textColor: Colors.white,)
        ],
      ),
      body: ListView(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(image:NetworkImage('https://www.eguardtech.com/wp-content/uploads/2018/08/Network-Profile.png'))
            )
          ),
          ...
          Card(margin: EdgeInsets.fromLTRB(0,0,0,10),child:Row(
            children:[
              Text('Password:',style:TextStyle(fontSize: 22)),
              RaisedButton(onPressed:(){},child:Text('Change Password',style:TextStyle(fontSize: 22,fontWeight:FontWeight.bold))),
            ],
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
