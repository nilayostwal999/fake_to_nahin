            ...
            child: Padding(
                ...
                child: Column(children: [
                  RichText(
                      text: TextSpan(
                          text:
                              'Heading can be too large to fit in a single line. Hence new line should get introduced.',
                          style: TextStyle(
                              fontSize: 26,
                              color: Colors.green,
                  ...
                  RichText(
                      text: TextSpan(
                          text:
                              'Description provided by posting person may be very long but would get displayed here',
                          style: TextStyle(fontSize: 20, color: Colors.black))),
                  Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                    Text(
                      'Name Of Posting Person',
                      style: TextStyle(
                          color: Colors.black,
                          fontSize: 20,
                          fontWeight: FontWeight.bold),
