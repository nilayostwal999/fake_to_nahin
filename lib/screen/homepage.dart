...
class _homeeState extends State<homee> {
  ...
  Widget build(BuildContext context) {
    return Column(children:[buildSizedBox()]);
  }
}
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  Text("description", style: TextStyle(color:Colors.grey,fontWeight: FontWeight.w400,fontSize: 14.0,),overflow: TextOverflow.fade,),
                ]) 
          ...
          SizedBox(
            ...
            child: Column(
              children:[
                Text('Unique\nLinks\nAvailable:\n',style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.w400,decoration: TextDecoration.underline),textAlign: TextAlign.center,),
                Text("links",style: TextStyle(fontSize: 24, fontWeight:FontWeight.bold),)
              ]
            ),
          )
        ],
